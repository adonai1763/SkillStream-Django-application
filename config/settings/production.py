...
] + MIDDLEWARE[1:]  # Keep the rest of the middleware
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'noreply@skillstream.com')
...
# File storage for production (AWS S3 recommended)
...
# Production logging
LOGGING['handlers']['file']['filename'] = '/var/log/skillstream/django.log'
